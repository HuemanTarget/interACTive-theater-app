...
const ResultsCBC = () => {
    return(
        ...
        <div>
            ...
            <h3>2 - Professor Donk Fell Through The Trap Door.</h3>
            <h3>3 - Bitana The Great Was Found To Be The Murderer.</h3> <br/>
        ...
        <div className='share'>
            <FacebookShareButton
                ...
                quote="The Sofias and Professor Donk were just murdered by Bitana The Great. I found 1 of 27 endings.">
                <FacebookIcon
                size={60}
                round
            />
