...
const ResultsBBB = () => {
    return(
        ...
        <div>
            ...
            <h3>2 - Blake Johnson Fell Through The Trap Door.</h3>
            <h3>3 - The Sophias Were Found To Be The Murderers.</h3> <br/>
        ...
        <div className='share'>
            <FacebookShareButton
                ...
                quote="Ernie Middleware and Blake Johnson were just murdered by The Sophias. I found 1 of 27 endings.">
                <FacebookIcon
                size={60}
                round
            />
