...
function QuestionsThreeBB() {
  ...
  const nextQuestion = () => {
    ...
    if (a[0] === answers[0].answer) {
      return(
        <div>
          <NavLink exact to='/playbill-four-bba'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-bbb'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-bbc'>
            Question Four
          </NavLink>
        </div>
      )
...
export default QuestionsThreeBB;
