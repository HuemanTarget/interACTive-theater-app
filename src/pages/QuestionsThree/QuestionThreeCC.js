...
function QuestionsThreeCC() {
  ...
  const questions = [
    {
        ...
        answer_a: 'Mustang Zane',
        answer_b: 'Blake Johnson',
        answer_c: 'Bitana The Great',
    },
  ];
  ...
  const nextQuestion = () => {
    ...
    if (a[0] === answers[0].answer) {
      return(
        <div>
          <NavLink exact to='/playbill-four-cca'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-ccb'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-ccc'>
            Question Four
          </NavLink>
        </div>
      )
...
export default QuestionsThreeCC;
