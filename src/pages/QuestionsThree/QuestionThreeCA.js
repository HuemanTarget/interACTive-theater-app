...
function QuestionsThreeCA() {
  ...
  const nextQuestion = () => {
    ...
    if (a[0] === answers[0].answer) {
      return(
        <div>
          <NavLink exact to='/playbill-four-caa'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-cab'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-cac'>
            Question Four
          </NavLink>
        </div>
      )
...
export default QuestionsThreeCA;
