...
function QuestionsThreeCB() {
  ...
  const nextQuestion = () => {
    ...
    if (a[0] === answers[0].answer) {
      return(
        <div>
          <NavLink exact to='/playbill-four-cba'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-cbb'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-cbc'>
            Question Four
          </NavLink>
        </div>
      )
...
export default QuestionsThreeCB;
