...
function QuestionsThreeBC() {
  ...
  const nextQuestion = () => {
    ...
    if (a[0] === answers[0].answer) {
      return(
        <div>
          <NavLink exact to='/playbill-four-bca'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-bcb'>
            Question Four
          </NavLink>
        </div>
      )
      ...
      return(
        <div>
          <NavLink exact to='/playbill-four-bcc'>
            Question Four
          </NavLink>
        </div>
      )
...
export default QuestionsThreeBC;
